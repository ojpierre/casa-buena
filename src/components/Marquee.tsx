export function Marquee() {
  const content = "NOW IN BOTTLE · BEST SERVED CHILLED · #SWITCHUPYOURVIBE · FRUIT WINE FROM SPAIN · GREAT VIBES ONLY · SWEET RED · SWEET WHITE · 8% ABV · MADE WITH IMAGINATION · CASA BUENA · ";
